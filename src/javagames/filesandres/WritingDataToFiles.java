...
public class WritingDataToFiles {
    ...
    public void writeOutBytes(String fileName){
        ...
        try{
            ...
            for(int i=0;i<1000;++i)out.write(rand.nextInt(256));
    ...
    public void writeOutStrings(String fileName){
        ...
        String[] strings={
                ...
                "ullamco laboris nisi ut aliquip ex ea commdodo consequat.",
                "Duis aute irere dolor in reprehenderit in voluptate velit",
        ...
        try{
            ...
            for(String string:strings)out.println(string);
        }catch (FileNotFoundException fex){
            fex.printStackTrace();
        }finally {
            try{
