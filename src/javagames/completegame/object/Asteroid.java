...
public class Asteroid {
   ...
   // public Sprite getSprite(){return sprite;}
    ...
    public Vector2f[] getPolygon(){return polygon;}
    ...
    public void update(float time){
        ...
        wrapper.wrapPosition(world,position,positionList);
    }
   ...
   // public void draw(Graphics2D g,Matrix3x3f view){
     //   for(Vector2f pos:positionList)sprite.render(g,view,pos,rotation);}
    public boolean contains(Vector2f point){
        for (Vector2f[] polygon:collisionList)if(pointInPolygon(point,polygon))return true;
        return false;
    }
