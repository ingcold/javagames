...
public class PrototypeAsteroidFactory {
    private static final Vector2f[][] LARGE={
            {//Large0
                ...
                new Vector2f(0.017244417f,0.158059480f),
            },{//Large1
    ...
    private static final Vector2f[][] MEDIUM={
            {//Medium0
                ...
                new Vector2f(-0.107981205f,-00.073552370f),
    ...
    private static final Vector2f[][] SMALL={
            {//Small0
                new Vector2f(-0.048513293f,0.057902990f),
                    new Vector2f(-0.073552430f,-0.0422543494f),
            ...
            new Vector2f(-0.004694819f,-00.067292690f),//
    ...
    private Vector2f[] getRandomAsteroid(Vector2f[][] asteroid){//这里getRandomAsteroid传入的是Vector2f而不是PrototypeAsteroid
        return mirror(asteroid[rand.nextInt(asteroid.length)]);//注意参数Vector2f[][] asteroid对应Large,Medium,Small
    }
    private Vector2f[] mirror(Vector2f[] polygon){
        ...
        for(int i=0;i<polygon.length;++i)mirror[i]=mat.mul(polygon[i]);
        return mirror;
    }
}
